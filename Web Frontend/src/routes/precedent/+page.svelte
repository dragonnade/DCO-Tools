...
<script lang="ts">
    ...
    async function fetchSimilarArticles(articleId: string, articleDetails: Article) {
        try {
            ...
            const response = await fetch(`/api/articles/similar?articleId=${articleId}`);
            const data = await response.json();
...
<div class="page-container">
    <div class="content-card">
        ...
        <div class="sm">
            <p text-xs>This tool shows the precedent for a particular article. To find how an article has been used as precedent in later DCOs, please use <a href="/updateprecedent">Update Precedents</a></p>
        </div>
