<script lang="ts">
    ...
    function applyFilters() {
        ...
        filteredDocuments = documents.filter(doc => {
            ...
            if (dateRange.start && new Date(doc.date_published) < dateRange.start) {
                return false;
            }

            if (dateRange.end && new Date(doc.date_published) > dateRange.end) {
                return false;
            }
                ...
                {#each filteredDocuments as doc}
                    <div class="border-b pb-3">
                        ...
                        <div class="flex justify-between mt-1 text-sm text-gray-600">
                            ...
                            <span>Date: {formatDate(doc.date_published)}</span>
                        </div>
