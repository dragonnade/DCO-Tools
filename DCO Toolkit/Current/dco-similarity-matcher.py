...
def categorize_article(title: str) -> str:
    # These categories are meaningless, but help demonstrate the value of categorisation.
    # Will need to be updated to categories that make sense to someone working on DCOs.
    # Will also need to have some sort of explanatory note as to what the categories mean, for users searching DCO provisions.
    category_patterns = {
